...
class CountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counter" do
    assert_difference("Counter.count") do
      post counters_url, params: { counter: { counter_cert_training: @counter.counter_cert_training, store_id: @counter.store_id, user_id: @counter.user_id } }
    end
  ...
  test "should update counter" do
    patch counter_url(@counter), params: { counter: { counter_cert_training: @counter.counter_cert_training, store_id: @counter.store_id, user_id: @counter.user_id } }
